MAIN	:= 	ft_memset.c ft_bzero.c ft_strlen.c ft_strcpy.c \
			...
			ft_lstmap.c ft_lst_push_back.c ft_strndup.c ft_strnjoin.c \
			ft_put_array.c ft_array_len.c ft_strtrim_spc.c \
			ft_strsplit_spc.c ft_isnumber.c ft_strclean.c ft_atol.c \
			ft_putdouble.c

OBJ	:= $(OBJ) $(MAIN:.c=.o)

$(DIROBJ)/%.o: $(DIRFT)/%.c $(HEAD)
	$(COMPIL)
